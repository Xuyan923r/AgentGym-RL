...
# except this launcher defaults to the 3B model with wm loss enabled.
...
EXP_NAME="${EXP_NAME:-ALFWORLD_GRPO_Qwen25_3B_SCORE_WM_LEN6000_BS8_0123_${RUN_TS}}"
RUN_ID="${RUN_ID:-aw0123_${RUN_TS}}"
ARTIFACT_DIR="${ARTIFACT_DIR:-${ROOT}/runtime/${RUN_ID}}"
LOG_DIR="${LOG_DIR:-${ARTIFACT_DIR}/logs}"
HOME_DIR="${HOME_DIR:-${ARTIFACT_DIR}/home}"
CKPT_DIR="${CKPT_DIR:-${ARTIFACT_DIR}/checkpoints}"
RUN_DIR="${RUN_DIR:-${ARTIFACT_DIR}}"
ROLLOUT_LOG_DIR="${ROLLOUT_LOG_DIR:-${ARTIFACT_DIR}/rollout_logs}"
RUNTIME_BASE="${RUNTIME_BASE:-${ARTIFACT_DIR}/runtime}"
RAY_REAL_DIR="${RAY_REAL_DIR:-${ARTIFACT_DIR}/ray}"
RAY_LINK_NAME="${RAY_LINK_NAME:-r${RUN_TS:9:6}}"
RAY_TMP_LINK="${RAY_TMP_LINK:-${ROOT}/${RAY_LINK_NAME}}"
RAY_TMPDIR="${RAY_TMPDIR:-${RAY_TMP_LINK}}"
TMPDIR="${TMPDIR:-${ARTIFACT_DIR}/tmp}"
TMP="${TMP:-${TMPDIR}}"
TEMP="${TEMP:-${TMPDIR}}"
HF_HOME="${HF_HOME:-${ARTIFACT_DIR}/hf}"
TRANSFORMERS_CACHE="${TRANSFORMERS_CACHE:-${HF_HOME}/hub}"
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-${HF_HOME}/datasets}"
XDG_CACHE_HOME="${XDG_CACHE_HOME:-${ARTIFACT_DIR}/xdg}"
WANDB_DIR="${WANDB_DIR:-${ARTIFACT_DIR}/wandb}"
...
TRAIN_SESSION="${TRAIN_SESSION:-alfworld_grpo_${RUN_TS}}"
ENV_LOG="${ENV_LOG:-${LOG_DIR}/alfworld_env.log}"
...
ln -sfn "${RAY_REAL_DIR}" "${RAY_TMP_LINK}"
