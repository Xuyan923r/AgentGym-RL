...
WM_SFT_FILE="${WM_SFT_FILE:-${ROOT}/AgentItemId/alfworld_wm_sft_train.json}"
...
# Appendix B.1 defaults for ALFWorld WM SFT
...
EXP_NAME="${EXP_NAME:-ALFWORLD_WM_SFT_Qwen25_7B_${RUN_TS}}"
PREP_SESSION="${PREP_SESSION:-alfworld_wm_sft_prep_${RUN_TS}}"
TRAIN_SESSION="${TRAIN_SESSION:-alfworld_wm_sft_${RUN_TS}}"
